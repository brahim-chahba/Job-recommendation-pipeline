...
const API_BASE = import.meta.env.VITE_MATCHER_API_URL ?? "http://localhost:5001/api";
    ...
    <main className="page-shell">
      ...
      <section className="hero-section" id="hero">
        <div className="hero-copy">
          <p className="eyebrow">Modele ML Gradient Boosting integre</p>
          <h1>Trouvez les offres au Maroc qui matchent votre profil.</h1>
          <p className="hero-text">
            Notre moteur analyse des milliers d&apos;offres, extrait les competences
            cles, et recommande les meilleures opportunites selon votre recherche.
          </p>
      ...
      <section className="search-section" id="search">
        <div className="section-heading">
          ...
          <h2>Decrivez votre profil ideal.</h2>
        </div>

        <form className="search-board" onSubmit={handleSearch}>
          <label>
            Poste ou competences
            <input
              type="text"
              value={searchTitle}
          ...
          >
            {isLoading ? "Analyse par IA..." : "Trouver des matchs"}
          </button>
        </form>
      </section>
      ...
      <section className="results-section" id="results">
        <div className="section-heading compact">
          <p className="eyebrow">Resultats recommandes</p>
          <h2>Top {matches.length} opportunites</h2>
        </div>
        ...
        <div className="job-list">
          ...
          {!isLoading && matches.length === 0 && (
            ...
            >
              Aucune offre ne correspond exactement a ces criteres. Essayez de modifier
              vos filtres.
            </div>
          )}
        </div>
      ...
      <section className="sources-section" id="sources">
        <div>
          <p className="eyebrow">Sources connectees</p>
